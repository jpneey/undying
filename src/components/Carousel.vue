...
<template>
  ...
  <section class="carousel pt-0 spacing position-relative w-100">
    ...
    >
      <swiper-slide v-for="media in data" class="position-relative maybe-rounded overflow-hidden d-flex align-items-end flex-wrap" @click="setupPreview( media, previewing )">
